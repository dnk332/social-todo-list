...
func ErrInterval(err error) *AppError {
	return NewFullErrorResponse(http.StatusInternalServerError, err, "something went wrong with server", err.Error(), "ErrInterval")
}
...
func ErrCannotListEntity(entity string, err error) *AppError {
	return NewCustomError(
		...
		fmt.Sprintf("ErrCannitList%s", entity),
	)
}
...
func ErrEntityExisted(entity string, err error) *AppError {
	return NewCustomError(
		...
		fmt.Sprintf("Err%sAleardyExists", entity),
	)
}
